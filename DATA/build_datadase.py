...
# ---------- DB CREATION ----------
def create_database(attendance_df, food_df, hospital_df, library_df, scoring_df, student_df):
...
def main():
    ...
    # Create database
    create_database(attendance_df, food_df, hospital_df, library_df, scoring_df, student_df)
